;(function() {
  ...
  function setupPlaceholderFill(progressiveMedia) {
  ...
  function setupAspectRatioPlaceholder(progressiveMedia) {
  ...
  function setupBlurImage(progressiveMedia) {
    ...
    renderLargeImage(progressiveMedia);
  }

  function renderLargeImage(progressiveMedia) {
  ...
  function initPilpil() {
    ...
    for (var i = 0; i < progressiveMedias.length; i++) {
      setupPlaceholderFill(progressiveMedias[i]);
      setupAspectRatioPlaceholder(progressiveMedias[i]);
      setupBlurImage(progressiveMedias[i]);
    }
  }
